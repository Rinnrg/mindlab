...
export const SINTAKS_MAP: Record<SintaksKey, SintaksInfo> = {
  sintaks_1: {
    ...
    description: "Mengorientasikan siswa pada masalah nyata yang akan menjadi dasar pembelajaran",
    descriptionEn: "Orienting students to real-world problems as the basis of learning",
    order: 1,
    icon: "🔍",
  },
  sintaks_2: {
